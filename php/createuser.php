...
<body style="background-color : #82E0AA;">
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO users(username,email,balance) VALUES('$username','$email','$balance')";
          ...
          <div class="screen-body-item">
            <form class="app-form" method="post">
              <div class="app-form-group">
                <input class="app-form-control" placeholder="username" type="text" name="username" maxlength="11" required>
              </div>
              <div class="app-form-group">
                <input class="app-form-control" placeholder="EMAIL" type="email" name="email" maxlength="51" required>
              </div>
              <div class="app-form-group">
                <input class="app-form-control" placeholder="BALANCE" type="number" name="balance" maxlength="4" required>
              </div>
              <br>
