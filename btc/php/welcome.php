  ...
  <div class="container-fluid">
    <div class="row intro py-1" style="background-color:cornflowerblue;">
      ...
      <div class="col-sm-12 col-md img text-center">
        <img src="../img/bank.jpg" class="img-fluid pt-2" style="margin-top:25px;padding:5px;width:60%">
      </div>
    </div><br>
    <div class="row activity text-center">
      <div class="col-md act">
        <a href="createuser.php"><button style="background-color : #2785C4;">Recharge Wallet</button></a><br>
        <img src="../img/user.jpg" class="img-fluid">
      </div>
      <div class="col-md act">
        <a href="transfermoney.php"><button style="background-color : #2785C4;">Make a Transaction</button></a><br>
        <img src="../img/transfer.jpg" class="img-fluid">
      </div>
      <div class="col-md act">
        <a href="transactionhistory.php"><button style="background-color : #2785C4;">Transaction History</button></a><br>
