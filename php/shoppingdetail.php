...
<body style="background-color : #E59866 ;">
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($amount > $sql1['balance']) {
      ...
      $purpose = 'Shopping from BitPe';
      date_default_timezone_set('Asia/Kolkata');
      $mydate = date('Y-m-d H:i:s');
      $sql = "INSERT INTO transaction(`sender`, `receiver`, `balance`,`purpose`,`datetime`) VALUE('$sender','$receiver','$amount','$purpose','$mydate')";
      $query = mysqli_query($conn, $sql);
      if ($query) {
  ...
  <div class="container">
    ...
    <div>
      <table class="table table-striped table-condensed table-bordered">
        <tr style="color : black;">
          ...
          <th class="text-center">Product Price (In INR)</th>
        ...
        <tr style="color : black;">
          ...
          <td class="py-2"><?php echo $quantity ?></td>
    ...
    <form method="post" name="tcredit" class="tabletext">
      ...
      <input type="number" class="form-control" value="<?php echo $quantity * $rows['price'] ?>" name="amount" readonly><br>
